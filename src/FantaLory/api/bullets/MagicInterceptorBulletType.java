...
public class MagicInterceptorBulletType extends InterceptorBulletType{
    public MagicInterceptorBulletType(float speed, float damage){
        super(speed, damage);
        MagicBulletSupport.setupDefaults(this);
    }

    public MagicInterceptorBulletType(){
        super();
        MagicBulletSupport.setupDefaults(this);
    }

    public MagicInterceptorBulletType(float speed, float damage, String bulletSprite){
