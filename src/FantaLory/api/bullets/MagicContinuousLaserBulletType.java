...
public class MagicContinuousLaserBulletType extends ContinuousLaserBulletType{
    public MagicContinuousLaserBulletType(float damage){
        super(damage);
        MagicBulletSupport.setupDefaults(this);
    }

    public MagicContinuousLaserBulletType(){
        super();
        MagicBulletSupport.setupDefaults(this);
    }
