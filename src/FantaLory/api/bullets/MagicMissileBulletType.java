...
public class MagicMissileBulletType extends MissileBulletType{
    public MagicMissileBulletType(float speed, float damage, String bulletSprite){
        super(speed, damage, bulletSprite);
        MagicBulletSupport.setupDefaults(this);
    }

    public MagicMissileBulletType(float speed, float damage){
        super(speed, damage);
        MagicBulletSupport.setupDefaults(this);
    }

    public MagicMissileBulletType(){
        super();
        MagicBulletSupport.setupDefaults(this);
    }
